...
public abstract class ListaGenerica<T> {
	...
	/**
	 * Agrega todos los elementos del parametro array en la lista generica actual
	 * **/
	public abstract boolean agregar(T arin[]);
	...
	public abstract boolean equals (ListaGenerica<T> comp);
	public abstract void eliminarTodos();
	public abstract void sumarLista(ListaGenerica<T> uni);
	public abstract void guardarEnCamino(ListaGenerica<T> caminoIn,ListaGenerica<T> caminoOut);
}
