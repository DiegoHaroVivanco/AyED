...
*/
    	...
    	/*
    	private double minimoCaudal(double caudal, ArbolGeneral<T> redAgua) {
    		double min = 99999;
    		if(!redAgua.esVacio()) {
    			if(redAgua.esHoja()) {
    				return caudal;
    				...
    				ListaGenerica<ArbolGeneral<T>> lHijos = redAgua.getHijos();
    				lHijos.comenzar();
    				while(!lHijos.fin()) {
    					min = this.minimoCaudal(caudal/lHijos.tamanio(), lHijos.proximo());
    				}
    			}
    		}
    		return min;
